    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PhotographyCompanyName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "AgentPhotograpyCompany",
                columns: table => new
                {
                    AgentsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PhotographyCompaniesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentPhotograpyCompany", x => new { x.AgentsId, x.PhotographyCompaniesId });
                    table.ForeignKey(
                        name: "FK_AgentPhotograpyCompany_Agents_AgentsId",
                        column: x => x.AgentsId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentPhotograpyCompany_PhotographyCompanies_PhotographyCompaniesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentPhotograpyCompany_PhotographyCompaniesId",
                table: "AgentPhotograpyCompany",
